...
class BufferPoolStatCPSObj:
    """
    Utility class to build a CPS Object based on the QoS BufferPool Stat Yang model
    ...
    dictionary returned by CPS Get on BufferPool Yang model and
    provides methods to extract various attributes from it.
    """

    yang_name='buffer-pool-stat'
